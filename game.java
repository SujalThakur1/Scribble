...
public class game
{
    ...
    public static void file(char[][] b ,int fufu , int fufu2) {
        ...
        do{
            ...
            switch(user){
                case 1:
                    savedFile.writeFile(b , fufu, fufu2);
                    valid = true;
                    break;
                case 2:
                    savedFile.writeFile2(b, fufu, fufu2);
                    valid = true;
                    break;
                case 3:
                    savedFile.writeFile3(b,fufu,fufu2);
                    valid = true;
                    break;

                case 4:
                    savedFile.writeFile4(b,fufu,fufu2);
                    valid = true;

                    break;
                case 5:
                    savedFile.writeFile5(b,fufu,fufu2);
                    valid = true;
                    break;
                default :
                    valid = false;
